...
public class DtoUtils {
    ...
    private static final String[] DEFAULT_IGNORE = {"metaClass", "metaMethods"};
    private static final String[] ENTITY_IGNORE = {"id", "dateCreated", "lastUpdated"};

    private static final BeanUtils BEAN_UTILS = new BeanUtils();
    ...
    public static <T> T copyProperties(Object source, T target, String... excludedProperties) {
        ...
        BeanTransformer transformer = BEAN_UTILS.getTransformer()
