...
import io.dmcs.servicebus.exceptions.DuplicateEndpointException;
...
public class ServiceRegistration {
    ...
    @Builder
	public ServiceRegistration(String name, String region, String environment, String instanceId, // NOSONAR
