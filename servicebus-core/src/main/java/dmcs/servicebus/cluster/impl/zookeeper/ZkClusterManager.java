...
import dmcs.servicebus.cluster.impl.zookeeper.leadership.ZkLeaderGroup;
import dmcs.servicebus.cluster.impl.zookeeper.locks.ZkLock;
...
public class ZkClusterManager extends AbstractClusterManager implements ConnectionStateListener {
    ...
    public ZkClusterManager(@NotNull ServiceBusProperties config,
